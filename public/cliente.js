...
const PASOS = [
  { carta:{k:"cultivo",c:"cafe"}, titulo:"Siembra tu finca",
    texto:"Cada turno tienes <b>dos jornales</b>. Sembrar, plagar o curar cuesta uno; "+
          "una faena cuesta los dos. Reúne <b>cuatro cultivos distintos y sanos</b> y ganas." },
...
function atril() {
  ...
  if (V.pendiente) panel = `<div class="fajita">Hay una respuesta pendiente…</div>`;
    ...
    if (!js.length) {
      ...
      if (V.jornales >= 2) b += `<button class="acc" data-descartar="1">Botar cartas</button>`;
    ...
    else if (V.jornales >= 2)
      b += `<div class="acciones"><button class="acc tenue" data-descartar="1">Botar cartas</button></div>`;
    else b += `<div class="acciones"><button class="acc tenue" data-pasar="1">Cerrar mi turno</button></div>`;
    panel = b;
  }
  ...
  const fincaHTML = `<div class="mifinca">
