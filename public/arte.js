...
function rotulos(carta){
  ...
  if(carta.k==="plaga") return {titulo:"PLAGA",
    ...
    nombre:M?M.nombreCarta(carta):(carta.t==="resistente"?"Plaga resistente":"Plaga")};
  if(carta.k==="remedio") return {titulo:carta.t==="bioinsumo"?"BIOINSUMO":"REMEDIO",
    sub:lbl(carta.c).toUpperCase(), nombre:M?M.nombreCarta(carta):(carta.t==="bioinsumo"?"Bioinsumo":"Remedio")};
