...
function explicaMata(o){
  if(esVivero(o))return "Vivero: crece bajo techo. Siempre cuenta como sano, "+
    "no le entra ninguna plaga y tampoco admite remedios.";
...
const API={COLORES,CULTIVO,FAENA,ESPANTOS,CLIMAS,MAZOS,mazoDe,JORNALES_TURNO,RONDAS_POR_CLIMA,
  ...
  afectaColor,tieneCultivo,descEstado,explicaMata,dañina,activo,
