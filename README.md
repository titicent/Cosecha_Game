...
- **Cosecha anunciada:** con cuatro cultivos distintos y sanos (cinco en el mano a mano) tu
  finca queda *lista* y se anuncia a toda la mesa. No ganas todavía: cada uno de los demás
  juega su turno y puede frenarte. Si al empezar tu siguiente turno la finca sigue completa,
  cosechas y ganas. Con la meta certificada activada, no basta con que estén sanos: hay que
  tenerlos certificados.
...
## Cómo está armado
    ...
    ritmo.js             ritmo de la partida y comparación de reglas (npm run ritmo)
    recolorea.py         remedios provisionales por color, sacados de tu arte
...
- **Nadie gana a mitad de turno.** La victoria se comprueba solo al empezar el turno de
  cada quien. Si un cambio de lindero te entrega una finca completa en el turno de otro, queda
  lista y cosechas al empezar el tuyo, si sigue completa. Antes se ganaba en el acto, y medido
  con `npm run ritmo`, una de cada tres o cuatro partidas la ganaba alguien sin que la mesa lo
  viera venir.
