...
Después de subir, comprueba en GitHub que exista `public/index.html`. Si el navegador aplanó la
estructura y los archivos de `public` quedaron sueltos en la raíz, la página no carga.
